...
class ParticipantsController(CommonController):
    ...
    def show_manage_participants_menu(self) -> None:
        ...
        elif request == Request.DELETE_PARTICIPANT:
    ...
    def show_add_participant_menu(self) -> None:
    ...
    def show_delete_participant_menu(self) -> None:
        ...
        if not participants_id:
            ...
            request, request_data = self.view.show_player_selection(participants_id)
            if request == Request.SELECTED_PLAYER:
                selected_id = request_data
    ...
    def show_list_participants_menu(self) -> None:
